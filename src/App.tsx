...
function App() {
  ...
  const [quantity, setQuantity] = useState(minimumTradeSizeSol)
  ...
  const executionEnabled = appMode === 'devnet' && !walletBusy && spotFresh && Number.isFinite(quantity) && quantity > 0 && quoteMode === 'maker' && hasExecutableQuote(selectedQuote, tradeSide, quantity) && Boolean(getSettlementProgramId())
